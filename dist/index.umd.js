(function (global, factory) {
  ...
  var _excluded$6 = ["onLoad", "apiKey", "libraries"],
  ...
  function useGoogleMapsApiLoader(props) {
    var onLoad = props.onLoad,
      ...
      otherApiParams = _objectWithoutPropertiesLoose(props, _excluded$6);
  ...
  var _excluded$5 = ["center", "zoom", "heading", "tilt"],
    _excluded2 = ["mapId"];
  /**
  ...
  function useMapOptions(map, cameraStateRef, mapProps) {
    var rawCenter = mapProps.center,
      ...
      tilt = mapProps.tilt,
      mapOptions = _objectWithoutPropertiesLoose(mapProps, _excluded$5);
  ...
  var _excluded$4 = ["id", "initialBounds"];
  ...
  function useMapInstance(props, context) {
    ...
    var id = props.id,
      ...
      mapOptions = _objectWithoutPropertiesLoose(props, _excluded$4);
  ...
  var _excluded$3 = ["children", "anchor", "onCloseClick"];
  /**
  ...
  var InfoWindow = function InfoWindow(props) {
    ...
    var children = props.children,
      ...
      infoWindowOptions = _objectWithoutPropertiesLoose(props, _excluded$3);
    var map = (_useContext = React.useContext(GoogleMapsContext)) == null ? void 0 : _useContext.map;
    var _useState = React.useState(null),
  ...
  var _excluded$2 = ["onClick", "onDrag", "onDragStart", "onDragEnd", "onMouseOver", "onMouseOut"];
  function useMarker(props) {
    ...
    var onClick = props.onClick,
      ...
      markerOptions = _objectWithoutPropertiesLoose(props, _excluded$2);
  ...
  var _excluded$1 = ["onClick", "onDrag", "onDragStart", "onDragEnd", "onMouseOver", "onMouseOut", "onRadiusChanged", "onCenterChanged", "radius", "center"];
  function useCircle(props) {
    ...
    var onClick = props.onClick,
      ...
      radius = props.radius,
      center = props.center,
      circleOptions = _objectWithoutPropertiesLoose(props, _excluded$1);
    ...
    var circle = React.useRef(new google.maps.Circle()).current;
    ...
    React.useEffect(function () {
      ...
      // Add event listeners
      var gme = google.maps.event;
      [['click', 'onClick'], ['drag', 'onDrag'], ['dragstart', 'onDragStart'], ['dragend', 'onDragEnd'], ['mouseover', 'onMouseOver'], ['mouseout', 'onMouseOut']].forEach(function (_ref) {
        var eventName = _ref[0],
          eventCallback = _ref[1];
        gme.addListener(circle, eventName, function (e) {
          var _callbacks$current$ev, _callbacks$current;
          return (_callbacks$current$ev = (_callbacks$current = callbacks.current)[eventCallback]) == null ? void 0 : _callbacks$current$ev.call(_callbacks$current, e);
        });
      });
      gme.addListener(circle, 'radius_changed', function () {
        var newRadius = circle.getRadius();
        callbacks.current.onRadiusChanged == null || callbacks.current.onRadiusChanged(newRadius);
      });
      gme.addListener(circle, 'center_changed', function () {
        var newCenter = circle.getCenter();
        callbacks.current.onCenterChanged == null || callbacks.current.onCenterChanged(newCenter);
      });
      return function () {
  ...
  var _excluded = ["onClick", "onDrag", "onDragStart", "onDragEnd", "onMouseOver", "onMouseOut", "encodedPaths"];
  function usePolygon(props) {
    ...
    var onClick = props.onClick,
      ...
      polygonOptions = _objectWithoutPropertiesLoose(props, _excluded);
    // This is here to avoid triggering the useEffect below when the callbacks change (which happen if the user didn't memoize them)
    var callbacks = React.useRef({});
    Object.assign(callbacks.current, {
      onClick: onClick,
    ...
    var geometryLibrary = useMapsLibrary('geometry');
    var polygon = React.useRef(new google.maps.Polygon()).current;
    ...
    React.useMemo(function () {
      ...
      var paths = encodedPaths.map(function (path) {
        return geometryLibrary.encoding.decodePath(path);
      });
    ...
    React.useEffect(function () {
      ...
      [['click', 'onClick'], ['drag', 'onDrag'], ['dragstart', 'onDragStart'], ['dragend', 'onDragEnd'], ['mouseover', 'onMouseOver'], ['mouseout', 'onMouseOut']].forEach(function (_ref) {
        var eventName = _ref[0],
          eventCallback = _ref[1];
        gme.addListener(polygon, eventName, function (e) {
          var _callbacks$current$ev, _callbacks$current;
          return (_callbacks$current$ev = (_callbacks$current = callbacks.current)[eventCallback]) == null ? void 0 : _callbacks$current$ev.call(_callbacks$current, e);
        });
      });
   ...
   */
  var Polygon = React.forwardRef(function (props, ref) {
